...
class FunctionsStatsCards extends StatelessWidget {
  final bool isDark;
  final bool isMobile;
  final int total;
  final int active;
  final int inactive;
  final int glFunctions;
  final int apFunctions;

  const FunctionsStatsCards({
    super.key,
    ...
    required this.glFunctions,
    required this.apFunctions,
  });
      ...
      builder: (context, constraints) {
        ...
        return Wrap(
          ...
          children: stats.map((stat) {
            return SizedBox(
              width: cardWidth,
              child: FunctionsStatCard(stat: stat, isDark: isDark),
            );
          }).toList(),
        );
      },
...
class FunctionsStatCard extends StatelessWidget {
  final Map<String, dynamic> stat;
  final bool isDark;

  const FunctionsStatCard({
    super.key,
    required this.stat,
    required this.isDark,
  });
